    ...
    <div class="card">
      <div class="flip">
        <div class="front">
          ...
          <div class="investor">Mr. Bitcoin</div>
          <div class="chip">
          ...
          <div class="end">
            ...
            <span class="end-date">Balance: {{ loggedInUser.balance }} </span>
          </div>
          <div class="card-holder"> {{ loggedInUser.name }}</div>
          <div class="master">
        ...
        <div class="back">
          ...
          <div class="ccv">
            <label>ccv</label>
            <div>{{ loggedInUser._id }}</div>
          </div>
          <div class="terms">
            <p>
              This card is property of Mr. Bitcoin Bank, Wonderland. Misuse is
              criminal offence. If found, please return to Mr. Bitcoin Bank. 
            </p>
