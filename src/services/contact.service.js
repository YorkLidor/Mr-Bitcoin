...
async function getContacts(filterBy = null) {
    var contactsFromLocal = await dbService.query(KEY)
    if (!contactsFromLocal || !contactsFromLocal.length) {
        contactsFromLocal = contacts
        await dbService.insert(KEY, contactsFromLocal)
    }
...
async function getContactById(id) {
    try {
        ...
        console.log('cannot get contact', err)
    }
...
async function saveContact(contact) {
    try {
        ...
        console.log('cannot add/edit', err)
    }
